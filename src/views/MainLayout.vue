<template>
	...
	<div class="flex flex-col h-full">
		<img src="images/bg-soft-2.png" class="hidden sm:block fixed -top-10 left-0 w-custom-big"/>
		<img src="images/bg-soft-1.png" class="hidden sm:block fixed -top-10 -right-44 2xl:-right-5 w-custom-big"/>
