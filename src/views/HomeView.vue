<template>
  <main>
    ...
    <div id="wordOfTheDayCotainer" class="flex flex-col justify-between mt-custom mb-0 md:mb-20 md:grid md:grid-cols-3 md:gap-2.5 px-5 sm:px-0">
      <div class="flex col-span-2">
        ...
        <WWShowCard v-if="randomArticle" :article="randomArticle" class=" w-4/5 sm:w-full -ml-8 sm:m-0" :WWCardHomeView="true" />
      </div>
