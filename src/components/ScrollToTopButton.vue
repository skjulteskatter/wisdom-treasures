<template>
    <BaseButton @click="scrollToTop" theme="threeDBtn" class="opacity-0 shadow-xl" :class="[{'buttonAppear': showButton, 'buttonDisAppear' : showButton === false, 'hidden' : initialOff}]">
        Back to the top
    </BaseButton>
</template>
