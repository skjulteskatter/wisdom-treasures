<template>
    <main>
        <BaseButton @click="clicked" :threeD="true" :loading="loading" :loadingLabel="loadingLabel" class="w-[calc(100%-2px)] h-[calc(100%-4px)] absolute top-1 left-[2px]" theme="threeDBtn">
            <template #default>
                <slot/>
            </template>
