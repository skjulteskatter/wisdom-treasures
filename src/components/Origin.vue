<template>
    <div class="flex flex-col justify-between items-center text-center cursor-pointer" @click="()=>{$router.push({path: `${originsOrCurrentPath}${origin.id}`})}">
        <div class="w-24 h-24 flex justify-center items-center rounded-xl overflow-hidden hover:border-black/30 border-2 border-transparent hover:shadow-xl hover:border-solid ">
